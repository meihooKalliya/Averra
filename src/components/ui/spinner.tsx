...
const CircleFilled = ({ className, size = 24, ...props }: SpinnerVariantProps) => (
  <div className="relative" style={{ width: size, height: size }}>
    <div className="absolute inset-0 rotate-180">
      <LoaderCircleIcon className={cn("animate-spin text-foreground opacity-20", className)} size={size} {...props} />
    </div>
...
export type SpinnerProps = React.ComponentProps<typeof LoaderIcon> & {
